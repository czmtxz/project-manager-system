...
REPORT_CARD_ICONS = {
    ...
    'sales-outbound-detail': 'bi-table',
    'pts-summary-detail': 'bi-layers',
...
REPORTS = {
    ...
    'sales-outbound-detail': {
        'title': '销售出库明细表',
        'module': 'sales',
        'description': '出库明细与运费，支持按品名、规格、客户、日期、项目等维度汇总',
        'filters': [
            'date_from', 'date_to', 'project_id', 'customer_name',
            'item_name', 'specification', 'group_by',
        ],
        'phase': 1,
        'enabled': True,
        'template': 'sales_outbound_detail.html',
    },
    'pts-summary-detail': {
        'title': '采运销汇总明细表',
        'module': 'global',
        'description': '采购、运费、销售出库的数量与金额一览，支持多维度汇总与筛选，含表尾合计',
        'filters': [
            'date_from', 'date_to', 'project_id', 'supplier', 'customer_name',
            'item_name', 'specification', 'group_by', 'include_draft',
        ],
        'phase': 1,
        'enabled': True,
        'template': 'pts_summary_detail.html',
    },
    'sales-collection': {
        'title': '销售回款分析',
        'module': 'sales',
